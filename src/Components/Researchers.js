...
const Researchers = () => {
  ...
  <Grid xs={12} sm={12} md={12} lg={4}>
    <Box className={classes.imageContainer}>
     ...
     <Typography className={classes.boldText}>Meet the researchers who've created projects for free on the Zooniverse</Typography> 
     <Typography><span>Meet the researchers who’ve created projects for free on the Zooniverse</span> From classifying animals in the Serengeti to discovering new exoplanets using the Kepler space telescope, researchers of all backgrounds have used the free project builder to create engaging, accessible citizen science projects. Our researchers have used the data from their projects to publish over 100 peer-reviewed publications that encourage many fascinating discoveries. Researchers take part in project creation, data analysis, and even communicate directly with volunteers through Zooniverse Talk.</Typography>
